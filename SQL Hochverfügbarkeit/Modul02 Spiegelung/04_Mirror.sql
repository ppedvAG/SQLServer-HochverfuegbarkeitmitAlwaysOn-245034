...
--RecoveryModel muss Full sein
--es muss mind Std vorliegen und mind eine V und ein T Sicherung
--Port 5022 frei?
--V+T muss auf dem Sekundären Server in NoRecovery restored werden
--auf beiden Seiten muss der gleiche BackUpRestore Zustand herrschen:
S1: VTTTT  ---> VTTTT
